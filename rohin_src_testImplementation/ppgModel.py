...
video_frames, frame_ct, fps = preprocessing.read_video("/Users/naveenmirapuri/PycharmProjects/Remote-PPG/rohin_src/Videos/test_short.mov")
...
for i, video in enumerate(lap_video):
    if i == 0 or i == len(video_frames)-1:
        continue
